...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Hidden achievement
		...
		["Broken Power Rangers",		"Beat \"Every Lemon Demon Song\" on Hard with no Misses.",false],
		["My Muscles, My Muscles",		"Beat \"Two Trucks\" on Hard with no Misses.",false],
		["Haunted Power Rangers",		"Beat \"Every Lemon Demon Song\" on Harder with no Misses.",false],
		["A Really Weird Song",			"Beat \"Two Trucks\" on Ruby with no Misses.",false],
		["What a Funkin' Disaster!",	"Complete a Song with a rating lower than 20%.",		true],
		["Ultimate Rapper of Ultimate Destiny",	"Complete a Song with a rating of 100%.",				false],
